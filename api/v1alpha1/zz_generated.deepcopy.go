...
func (in *ImagePolicySpec) DeepCopyInto(out *ImagePolicySpec) {
	*out = *in
	...
	if in.TagPrefixMatcher != nil {
		in, out := &in.TagPrefixMatcher, &out.TagPrefixMatcher
		*out = new(TagPrefixMatcher)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TagPrefixMatcher) DeepCopyInto(out *TagPrefixMatcher) {
	*out = *in
	if in.Include != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TagPrefixMatcher.
func (in *TagPrefixMatcher) DeepCopy() *TagPrefixMatcher {
	if in == nil {
		return nil
	}
	out := new(TagPrefixMatcher)
